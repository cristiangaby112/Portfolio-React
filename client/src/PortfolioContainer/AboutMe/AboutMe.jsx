...
export default function AboutMe(props) {
  ...
  const SCREEN_CONSTANT = {
    description: "Desarrollador web y móvil con conocimientos en front-end y back-end, junto con una habilidad especial para crear aplicaciones con la máxima eficiencia. Dispuesto a aportar y ser productivo para cualquier empresa.",
    highlights:{
      bullets:[
